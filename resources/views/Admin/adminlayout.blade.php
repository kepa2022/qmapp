  ...
  <body>
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          <li class="nav-item nav-profile border-bottom">
            <a href="#" class="nav-link flex-column">
              <div class="nav-profile-image">
                <img src="../assets/images/faces/face1.jpg" alt="profile" id="imgprofile" />
                <!--change to offline or busy as needed-->
              </div>
              <div class="nav-profile-text d-flex ms-0 mb-3 flex-column">
                <span class="font-weight-semibold mb-1 mt-2 text-center">{{ Auth::user()->name }}</span>
                <span class="text-secondary icon-sm text-center">{{ Auth::user()-> roleid==('1')?'Super Admin':Auth::user()-> roleid==('2') ?'Admin':'User'; }}</span>
              </div>
            </a>
          </li>
          ...
          <li class="nav-item">
            <a class="nav-link" data-bs-toggle="collapse" href="{{ route('admin_userlist') }}" onclick="event.preventDefault();
                                                     document.getElementById('userlist-form').submit();" aria-expanded="false" aria-controls="ui-basic">
              <i class="mdi mdi-crosshairs-gps menu-icon"></i>
              <span class="menu-title">USERS</span>
              <i class="menu-arrow"></i>
              <form id="userlist-form" action="{{ route('admin_userlist') }}" method="GET">
                                        @csrf
                                        </form>
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
          <div class="navbar-menu-wrapper d-flex align-items-stretch">
            ...
            <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
              <a class="navbar-brand brand-logo-mini" href="\admin\home"><img src="../assets/images/logo-mini.svg" alt="logo" /></a>
            </div>
            <ul class="navbar-nav">
        ...
        <div class="main-panel">
          <div class="content-wrapper pb-0">
            ...
            @yield('Admin_usercreate')
            @yield('Admin_userlist')
          ...
          <footer class="footer">
            <div class="d-sm-flex justify-content-center justify-content-sm-between">
              <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Copyright © 2022 <a href="#" target="_blank">C-LAB KEPA</a>. All rights reserved.</span>
