...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/vendors/flag-icon-css/css/flag-icon.min.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/vendors/css/vendor.bundle.base.css') }}">
 

    <!-- endinject -->
    <!-- Plugin css for this page -->
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/vendors/jquery-bar-rating/css-stars.css') }}">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          <li class="nav-item nav-profile border-bottom">
            <a href="#" class="nav-link flex-column">
              <div class="nav-profile-image" >
                ...
                <img src="{{ asset('images/emptyprofile.png') }}"  id="imgprofile"/> 
          ...
          <li class="nav-item pt-3">
            <a class="nav-link d-block" href="https://keralapolice.gov.in/page/who-is-who-kerala-police-academy" target="_blank">
              <img class="sidebar-brand-logo" src="../images/Kerala-Police-Academy-Logo.png" width="40%" height="40%" alt="" />KEPA HOME
                ...
                <div class="dropdown-menu dropdown-menu-left navbar-dropdown preview-list" aria-labelledby="messageDropdown">
                  ...
                  <a class="dropdown-item preview-item">
                    <div class="preview-thumbnail">
                      <!--<img src="../assets/images/emptyprofile.png" alt="image" class="profile-pic"> -->
                    </div>
        ...
        <div class="main-panel">
          ...
          <footer class="footer">
            <div class="d-sm-flex justify-content-center justify-content-sm-between">
              <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Copyright © 2022  C-LAB KEPA. All rights reserved.</span>
